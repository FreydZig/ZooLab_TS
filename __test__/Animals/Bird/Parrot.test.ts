...
describe('Parrot', () => {
    it('Should be able to create Parrot', () => {
        ...
        expect(parrot.FeedSchedule[0]).toBe(10);
    ...
    it('Should not be able to create Parrot', () => {
        expect(() => new Parrot(4, 'Meet', [new FeedTime(new Date(), new ZooKeeper())], [10], false, 1)).toThrowError('requiredSpaceSqFt < 5 or/and favouriteFood is not Grass');
    })
