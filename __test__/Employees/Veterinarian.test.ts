...
describe('Veterinarian', () => {
    ...
    it('Should be able to Add Animal Experiences', () => {
        const veterinarian = new Veterinarian('Bob', 'Faat', 'Snake');
        const bison = new Bison(1000, 'Grass', [new FeedTime(new Date(), new Veterinarian('Bob', 'Faat', 'Snake'))], [10], false, 1);
    ...
    it('Should be able to Has Animal Experiences', () => {
        const veterinarian = new Veterinarian('Bob', 'Faat', 'Snake');
        const snake = new Snake(2, 'Meet', [new FeedTime(new Date(), new Veterinarian('Bob', 'Faat', 'Snake'))], [10], false, 1);
    ...
    it('Should be able to Heel Animal', () => {
        const veterinarian = new Veterinarian('Bob', 'Faat', 'Snake');
        const snake = new Snake(2, 'Meet', [new FeedTime(new Date(), new Veterinarian('Bob', 'Faat', 'Snake'))], [10], true, 1);
    ...
    it('Should not be able to Heel Animal', () => {
        const veterinarian = new Veterinarian('Bob', 'Faat', 'Snake');
        const bison = new Bison(1000, 'Grass', [new FeedTime(new Date(), new Veterinarian('Bob', 'Faat', 'Snake'))], [10], true, 1);
